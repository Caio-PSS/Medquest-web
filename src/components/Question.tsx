    ...
    <div className="max-w-4xl mx-auto bg-gray-900 rounded-2xl p-8 shadow-2xl">
      ...
      {!showFeedback && (
        <div className="flex gap-4 mt-8 justify-between">
          <button
            onClick={onComplete}
            className="border border-red-500/50 text-red-300 py-3 px-4 rounded-lg hover:border-red-400 hover:text-red-200 transition-all duration-200 flex items-center gap-2 group"
          >
